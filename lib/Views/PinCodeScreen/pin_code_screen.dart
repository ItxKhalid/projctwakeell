...
class PinCodeClientScreen extends StatefulWidget {
  const PinCodeClientScreen({super.key});

  @override
  State<PinCodeClientScreen> createState() => _PinCodeClientScreenState();
}
class _PinCodeClientScreenState extends State<PinCodeClientScreen> {
