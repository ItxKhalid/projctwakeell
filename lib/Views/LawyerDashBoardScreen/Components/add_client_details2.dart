...
class AddClientScreen2 extends StatefulWidget {
  final String name;
  final String id;
  final String phoneNo;

  const AddClientScreen2({Key? key, required this.id,required this.name,required this.phoneNo}) : super(key: key);

  @override
  State<AddClientScreen2> createState() => _AddClientScreen2State();
}

class _AddClientScreen2State extends State<AddClientScreen2> {


  @override
  Widget build(BuildContext context) {
    final TextEditingController _fullNameController = TextEditingController(text: widget.name);
