                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      if (firstName.isNotEmpty && lastName.isNotEmpty && email.isNotEmpty && licenseNumber.isNotEmpty && phoneNumber.isNotEmpty)
                      {
                      try {
                      DocumentReference docRef = await FirebaseFirestore.instance.collection('lawyer').add({
                      'firstName': firstName,
                      'lastName': lastName,
                      'email': email,
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context) => SignUpAsLawyer2Screen
                      ...
                      firstname1Controller.clear();
                      lastname1Controller.clear();
