...
class ClientDashboardScreen extends StatefulWidget {
  ...
  const ClientDashboardScreen(
      {super.key, required this.userModel, required this.loggedInUser});
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Center(
                                          child: CustomText(
                                            textAlign: TextAlign.center,
                                            text: AppLocalizations.of(context)!.case_category,
                                            color: themeProvider.themeMode ==
                                                    ThemeMode.dark
                                                ? AppColors.white
                                                : AppColors.black,
                                ...
                                InkWell(
                                  onTap: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => const MyLawyerScreens(),
                                      ),
                                    );
                                  },
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomText(
                                          textAlign: TextAlign.center,
                                          text: AppLocalizations.of(context)!.my_lawyer,
                                          color: themeProvider.themeMode ==
                                                  ThemeMode.dark
                                              ? AppColors.white
                                              : AppColors.black,
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomText(
                                          textAlign: TextAlign.center,
                                          text: AppLocalizations.of(context)!.my_documents,
                                          color: themeProvider.themeMode ==
                                                  ThemeMode.dark
                                              ? AppColors.white
                                              : AppColors.black,
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        CustomText(
                                          textAlign: TextAlign.center,
                                          text: AppLocalizations.of(context)!.case_status,
                                          color: themeProvider.themeMode ==
                                                  ThemeMode.dark
                                              ? AppColors.white
                                              : AppColors.black,
